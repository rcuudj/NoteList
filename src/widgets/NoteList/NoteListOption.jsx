...
const NoteListOption = ({ handlShowList, isList }) => {
    return (
        <>
            <div className="note__list-options">
                <div className="note__list-options-content container">
                    <h2>Все заметки</h2>
                    <button className="note__list-option-button" onClick={() => { handlShowList() }}>
